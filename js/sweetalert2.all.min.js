!function (t, e) {
    ...
    function g(t, e) {
        e = '"'.concat(t, '" is deprecated and will be removed in the next major release. Please use "').concat(e, '" instead.'), -1 === ct.indexOf(e) && (ct.push(e), rt(e))
    }
    ...
    function U(t, e, n) {
        ...
        if (i = e, h((o = t).classList).forEach(function (t) {
            ...
            if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach) return rt("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(r(e.customClass[n]), '"'));
    ...
    function Q(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = q();
    ...
    function nt(t, e) {
        t instanceof HTMLElement ? e.appendChild(t) : "object" === r(t) ? wt(t, e) : t && R(e, t)
    }

    function ot(t, e) {
        var n = D(), o = j(), i = T(), r = L(), a = M();
        e.showConfirmButton || e.showDenyButton || e.showCancelButton || Z(n), U(n, e, "actions"), At(i, "confirm", e), At(r, "deny", e), At(a, "cancel", e), function (t, e, n, o) {
        ...
        }(i, r, a, e), e.reverseButtons && (n.insertBefore(a, o), n.insertBefore(r, o), n.insertBefore(i, o)), R(o, e.loaderHtml), U(o, e, "loader")
    }

    var it = "SweetAlert2:", rt = function (t) {
            console.warn("".concat(it, " ").concat("object" === r(t) ? t.join(" ") : t))
        }, at = function (t) {
            console.error("".concat(it, " ").concat(t))
        }, ct = [],
        st = Object.freeze({cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer"}),
        ut = function (t) {
            var e, n = {};
        ...
        yt = function (t) {
            var e, n, o, i, r,
                a = !!(i = A()) && (i.remove(), ht([document.documentElement, document.body], [lt["no-backdrop"], lt["toast-shown"], lt["has-column"]]), !0);
            tt() ? at("SweetAlert2 requires document to initialize") : ((r = document.createElement("div")).className = lt.container, a && mt(r, lt["no-transition"]), R(r, vt), (i = "string" == typeof (e = t.target) ? document.querySelector(e) : e).appendChild(r), a = t, (e = x()).setAttribute("role", a.toast ? "alert" : "dialog"), e.setAttribute("aria-live", a.toast ? "polite" : "assertive"), a.toast || e.setAttribute("aria-modal", "true"), r = i, "rtl" === window.getComputedStyle(r).direction && mt(A(), lt.rtl), t = x(), a = gt(t, lt.input), e = gt(t, lt.file), n = t.querySelector(".".concat(lt.range, " input")), o = t.querySelector(".".concat(lt.range, " output")), i = gt(t, lt.select), r = t.querySelector(".".concat(lt.checkbox, " input")), t = gt(t, lt.textarea), a.oninput = et, e.onchange = et, i.onchange = et, r.onchange = et, t.oninput = et, n.oninput = function () {
                et(), o.value = n.value
            }, n.onchange = function () {
    ...
    function At(t, e, n) {
        $(t, n["show".concat(m(e), "Button")], "inline-block"), R(t, n["".concat(e, "ButtonText")]), t.setAttribute("aria-label", n["".concat(e, "ButtonAriaLabel")]), t.className = lt[e], U(t, n, "".concat(e, "Button")), mt(t, n["".concat(e, "ButtonClass")])
    }

    function xt(t, e) {
        var n, o, i = A();
        i && (o = i, "string" == typeof (n = e.backdrop) ? o.style.background = n : n || mt([document.documentElement, document.body], lt["no-backdrop"]), !e.backdrop && e.allowOutsideClick && rt('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), o = i, (n = e.position) in lt ? mt(o, lt[n]) : (rt('The "position" parameter is not valid, defaulting to "center"'), mt(o, lt.center)), n = i, !(o = e.grow) || "string" != typeof o || (o = "grow-".concat(o)) in lt && mt(n, lt[o]), U(i, e, "container"))
    }
    ...
    var Et = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap},
        St = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Ot = function (t) {
            if (!Mt[t.input]) return at('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
    ...
    Mt.text = Mt.email = Mt.password = Mt.number = Mt.tel = Mt.url = function (t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : C(e.inputValue) || rt('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), Pt(t, t, e), Bt(t, e), t.type = e.input, t
        ...
        var n;
        return t.textContent = "", e.inputPlaceholder && (n = document.createElement("option"), R(n, e.inputPlaceholder), n.value = "", n.disabled = !0, n.selected = !0, t.appendChild(n)), Pt(t, t, e), t
    }, Mt.radio = function (t) {
        ...
        var n;
        return "MutationObserver" in window && (n = parseInt(window.getComputedStyle(x()).width), new MutationObserver(function () {
            var t,
    ...
    function Dt(t, e) {
        var o, i, r, n = E();
        U(n, e, "htmlContainer"), e.html ? (nt(e.html, n), Y(n, "block")) : e.text ? (n.textContent = e.text, Y(n, "block")) : Z(n), t = t, o = e, i = x(), t = Et.innerParams.get(t), r = !t || o.input !== t.input, St.forEach(function (t) {
            var e = lt[t], n = gt(i, e);
    ...
    function It(t, o) {
        ...
        Y(i), i.textContent = "", o.currentProgressStep >= o.progressSteps.length && rt("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.progressSteps.forEach(function (t, e) {
            var n, t = (n = t, t = document.createElement("li"), mt(t, lt["progress-step"]), R(t, n), t);
    ...
    var Vt = function (t, e) {
        ...
        if (e.iconColor) {
            ...
            for (var n = 0, o = [".swal2-success-line-tip", ".swal2-success-line-long", ".swal2-x-mark-line-left", ".swal2-x-mark-line-right"]; n < o.length; n++) J(t, o[n], "backgroundColor", e.iconColor);
            J(t, ".swal2-success-ring", "borderColor", e.iconColor)
        }
    }, Ut = function (t) {
        return '<div class="'.concat(lt["icon-content"], '">').concat(t, "</div>")
    }, _t = function (t, e) {
        t.className = "".concat(lt.popup, " ").concat(bt(t) ? e.showClass.popup : ""), e.toast ? (mt([document.documentElement, document.body], lt["toast-shown"]), mt(t, lt.toast)) : mt(t, lt.modal), U(t, e, "popup"), "string" == typeof e.customClass && mt(t, e.customClass), e.icon && mt(t, lt["icon-".concat(e.icon)])
    };

    function zt(t) {
        (e = x()) || Bn.fire();
        var e = x(), n = j();
        pt() ? Z(B()) : Zt(e, t), Y(n), e.setAttribute("data-loading", !0), e.setAttribute("aria-busy", !0), e.focus()
    }
    ...
    var Zt = function (t, e) {
        var n = D(), o = j();
        !e && bt(T()) && (e = T()), Y(n), e && (Z(e), o.setAttribute("data-button-to-replace", e.className)), o.parentNode.insertBefore(o, e), mt([t, n], lt.loading)
    }, Jt = {}, $t = !1, Xt = {};
    ...
    function ee(t) {
        for (var e in t) Qt(n = e) || rt('Unknown parameter "'.concat(n, '"')), t.toast && (n = e, -1 !== re.indexOf(n) && rt('The parameter "'.concat(n, '" is incompatible with toasts'))), te(e = e) && g(e, te(e));
        var n
    }
    ...
    var ne = {
        ...
        ae = Object.freeze({
            ...
            argsToParams: function (n) {
                var o = {};
                return "object" !== r(n[0]) || k(n[0]) ? ["title", "html", "icon"].forEach(function (t, e) {
                    e = n[e];
                    "string" == typeof e || k(e) ? o[t] = e : void 0 !== e && at("Unexpected type of ".concat(t, '! Expected "string" or "Element", got ').concat(r(e)))
                }) : s(o, n[0]), o
            },
            isVisible: function () {
                return bt(x())
    ...
    function ce() {
        ...
        e && (t = Et.domCache.get(this), Z(t.loader), pt() ? e.icon && Y(B()) : se(t), ht([t.popup, t.actions], lt.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1)
    }

    function se(t) {
        var e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"));
        e.length ? Y(e[0], "inline-block") : bt(T()) || bt(L()) || bt(M()) || Z(t.actions)
    }
    ...
    var le = function () {
        navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) || x().scrollHeight > window.innerHeight - 44 && (A().style.paddingBottom = "".concat(44, "px"))
    }, de = function () {
        var e, t = A();
        ...
        var e = t.target, n = A();
        return !fe(t) && !me(t) && (e === n || !(X(n) || "INPUT" === e.tagName || X(E()) && E().contains(e)))
    }, fe = function (t) {
    ...
    function ge(t, e, n, o) {
        pt() ? Ce(t, o) : (Wt(n).then(function () {
            return Ce(t, o)
        }), Jt.keydownTarget.removeEventListener("keydown", Jt.keydownHandler, {capture: Jt.keydownListenerCapture}), Jt.keydownHandlerAdded = !1), e.parentNode && e.remove(), N() && (null !== ft.previousBodyPadding && (document.body.style.paddingRight = "".concat(ft.previousBodyPadding, "px"), ft.previousBodyPadding = null), F(document.body, lt.iosfix) && (e = parseInt(document.body.style.top, 10), ht(document.body, lt.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * e), h(document.body.children).forEach(function (t) {
    ...
    function be(t) {
        var e, n, o, i = x();
        i && (t = ve(t), (e = Et.innerParams.get(this)) && !F(i, e.hideClass.popup) && (n = he.swalPromiseResolve.get(this), ht(i, e.showClass.popup), mt(i, e.hideClass.popup), o = A(), ht(o, e.showClass.backdrop), mt(o, e.hideClass.backdrop), ye(this, i, e), n(t)))
    }
    ...
    function Ee(t) {
        ...
        Ue(e, n, t), setTimeout(function () {
            Re(e, n)
        }, 10), N() && (Fe(e, t.scrollbarPadding, o), h(document.body.children).forEach(function (t) {
    ...
    function Se(t) {
        var e = x();
        t.target === e && (t = A(), e.removeEventListener(kt, Se), t.style.overflowY = "auto")
    }
    ...
    var Le = ["swal-title", "swal-html", "swal-footer"], je = function (t) {
        ...
        h(e.attributes).forEach(function (t) {
            -1 === n.indexOf(t.name) && rt(['Unrecognized attribute "'.concat(t.name, '" on <').concat(e.tagName.toLowerCase(), ">."), "".concat(n.length ? "Allowed attributes are: ".concat(n.join(", ")) : "To set the value, use HTML within the element.")])
        })
    }, Re = function (t, e) {
        kt && G(e) ? (t.style.overflowY = "hidden", e.addEventListener(kt, Se)) : t.style.overflowY = "auto"
    }, Fe = function (t, e, n) {
        var o;
        (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !F(document.body, lt.iosfix) && (o = document.body.scrollTop, document.body.style.top = "".concat(-1 * o, "px"), mt(document.body, lt.iosfix), de(), le()), e && "hidden" !== n && ue(), setTimeout(function () {
            t.scrollTop = 0
        })
    }, Ue = function (t, e, n) {
        mt(t, n.showClass.backdrop), e.style.setProperty("opacity", "0", "important"), Y(e, "grid"), setTimeout(function () {
        ...
        var i = x();
        y(n.inputOptions) || C(n.inputOptions) ? (zt(T()), w(n.inputOptions).then(function (t) {
            e.hideLoading(), o(t)
        })) : "object" === r(n.inputOptions) ? o(n.inputOptions) : at("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(r(n.inputOptions)))
    }, Ye = function (e, n) {
        var o = e.getInput();
        Z(o), w(n.inputValue).then(function (t) {
            o.value = "number" === n.input ? parseFloat(t) || 0 : "".concat(t), Y(o), o.focus(), e.hideLoading()
        }).catch(function (t) {
            at("Error in inputValue promise: ".concat(t)), o.value = "", Y(o), o.focus(), e.hideLoading()
        })
    }, Ze = {
        select: function (t, e, i) {
            function o(t, e, n) {
                var o = document.createElement("option");
                o.value = n, R(o, e), o.selected = $e(n, i.inputValue), t.appendChild(o)
            }
            ...
            e.forEach(function (t) {
                ...
                R(e, n), e.className = lt.label, t.appendChild(o), t.appendChild(e), r.appendChild(t)
            });
        ...
        e.inputValidator ? Ge(t, e, o) : t.getInput().checkValidity() ? ("deny" === n ? Qe : tn)(t, e, o) : (t.enableButtons(), t.showValidationMessage(e.validationMessage))
    }, Ge = function (e, n, o) {
        e.disableInput(), Promise.resolve().then(function () {
            return w(n.inputValidator(o, n.validationMessage))
        }).then(function (t) {
            e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : tn(e, n, o)
        })
    }, Qe = function (e, t, n) {
        t.showLoaderOnDeny && zt(L()), t.preDeny ? Promise.resolve().then(function () {
        ...
        t.showLoaderOnConfirm && zt(), t.preConfirm ? (e.resetValidationMessage(), Promise.resolve().then(function () {
            ...
            bt(O()) || !1 === t ? e.hideLoading() : Oe(e, void 0 === t ? n : t)
        })) : Oe(e, n)
        ...
        for (var n = t.target, o = V(), i = -1, r = 0; r < o.length; r++) if (n === o[r]) {
            i = r;
            break
        }
        t.shiftKey ? Te(0, i, -1) : Te(0, i, 1), t.stopPropagation(), t.preventDefault()
    }, cn = function (t) {
        -1 !== [T(), L(), M()].indexOf(document.activeElement) && (t = -1 !== en.indexOf(t) ? "nextElementSibling" : "previousElementSibling", (t = document.activeElement[t]) && t.focus())
    }, sn = function (t, e, n) {
        v(e.allowEscapeKey) && (t.preventDefault(), n(st.esc))
    }, un = function (e, t, n) {
        t.popup.onclick = function () {
            var t = Et.innerParams.get(e);
            t.showConfirmButton || t.showDenyButton || t.showCancelButton || t.showCloseButton || t.timer || t.input || n(st.close)
        }
    }, ln = !1, dn = function (e) {
        ...
        o.container.onclick = function (t) {
            ...
            ln ? ln = !1 : t.target === o.container && v(e.allowOutsideClick) && i(st.backdrop)
        }
    };
    ...
    var bn = function (t, e, n) {
        var o = q();
        Z(o), e.timer && (t.timeout = new xe(function () {
            n("timer"), delete t.timeout
        }, e.timer), e.timerProgressBar && (Y(o), setTimeout(function () {
            t.timeout && t.timeout.running && Q(e.timer)
        })))
    }, vn = function (t, e) {
        if (!e.toast) return v(e.allowEnterKey) ? void (yn(t, e) || Te(0, -1, 1)) : wn()
    }, yn = function (t, e) {
    ...
    var kn, An = function (t) {
        ...
        hideLoading: ce, disableLoading: ce, getInput: function (t) {
            ...
            R(e.validationMessage, t), e.validationMessage.className = lt["validation-message"], n.customClass && n.customClass.validationMessage && mt(e.validationMessage, n.customClass.validationMessage), Y(e.validationMessage), (e = this.getInput()) && (e.setAttribute("aria-invalid", !0), e.setAttribute("aria-describedBy", lt["validation-message"]), z(e), mt(e, lt.inputerror))
        }, resetValidationMessage: function () {
            var t = Et.domCache.get(this);
            t.validationMessage && Z(t.validationMessage), (t = this.getInput()) && (t.removeAttribute("aria-invalid"), t.removeAttribute("aria-describedBy"), ht(t, lt.inputerror))
            ...
            if (!t || F(t, n.hideClass.popup)) return rt("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            var o = {};
            Object.keys(e).forEach(function (t) {
                Bn.isUpdatableParameter(t) ? o[t] = e[t] : rt('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
        ...
        function i() {
            if (a(this, i), "undefined" != typeof window) {
                "undefined" == typeof Promise && at("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), kn = this;
                for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    }), xn.DismissReason = st, xn.version = "11.0.1";
    var Bn = xn;
